...
{
    public class Verbandskasten : Script
    {
        ...
        private async void RunFunction(CPlayer player, InventoryModel inventory, int slot, int amount)
        {
            ...
            // player.SendNotification("Weste gezogen!");
            player.SendCloudNotification($"Information", $"Du hast ein Verbandskasten benutzt.", 2500, NotificationModel.SUCCESS, false);
